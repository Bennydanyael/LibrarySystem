...
{
    public partial class InitialAppLibrary : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LibraryTrancs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LibraryTrancs_Books_BooksID",
                        column: x => x.BooksID,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LibraryTrancs_Customers_Id",
                        column: x => x.Id,
